...
spec =
  describe "valid cases" $ do
    ...
    specHelper 3 validCase19 $
      ...
      KNormal.Let
        ...
        (KNormal.Let ("Ti1.2.47", Type.Int) (KNormal.Int 0) $
         ...
         KNormal.Let ("Ti3.4.49", Type.Int) (KNormal.Int 1) $
         KNormal.Let ("Ti1.2.7.50", Type.Int) (KNormal.Int 0) $
         KNormal.Let
           ("Ti4.3.51", Type.Int)
           (KNormal.Let ("Ti2.5.8.52", Type.Int) (KNormal.Int 1) $
            KNormal.Let ("Ti3.4.9.53", Type.Int) (KNormal.Int 0) $
            KNormal.Let ("Ti1.2.15.54", Type.Int) (KNormal.Int 0) $
            KNormal.Let ("Ti4.3.10.55", Type.Int) (KNormal.Int 0) $ KNormal.Int 1) $
    ...
    specHelper 4 validCase19 $
      ...
      KNormal.Let ("Ti4.3.10.30", Type.Int) (KNormal.Int 3) $
      KNormal.Let ("Ti4.3.27", Type.Int) (KNormal.Int 6) $
      KNormal.Let ("Ti4.3.14", Type.Int) (KNormal.Int 10) $ KNormal.Int 15
    ...
    specHelper 3 validCase20 $
      ...
      KNormal.LetRec
        (KNormal.Fundef ("g.2.7", Type.Fun [Type.Int] Type.Int) [("y.3.8", Type.Int)] $ KNormal.Add "Ti0.5" "y.3.8") $
      KNormal.Let ("Ti2.6", Type.Int) (KNormal.Int 2) $ KNormal.Int 3
    ...
    specHelper 2 validCase21 $
      ...
      KNormal.Let ("Ti4.5.10", Type.Int) (KNormal.Int 2) $ KNormal.Int 7
    specHelper 1 validCase22 $
      ...
      KNormal.Let ("Ti4.0", Type.Int) (KNormal.Int 6) $ KNormal.Let ("Ti5.5", Type.Int) (KNormal.Int 4) $ KNormal.Int 10
    specHelper 1 validCase23 $
      Right $
      KNormal.Let ("Ti0.1", Type.Int) (KNormal.Int 1) $
      KNormal.Let ("Ti1.2", Type.Int) (KNormal.Int 2) $
      KNormal.Let ("Ti2.0", Type.Int) (KNormal.Int $ -1) $
      KNormal.Let ("Ti3.4", Type.Int) (KNormal.Int 3) $
      KNormal.Let ("Ti4.5", Type.Int) (KNormal.Int 4) $
      KNormal.Let ("Ti5.3", Type.Int) (KNormal.Int $ -1) $ KNormal.Int $ -2
    ...
    specHelper 1 validCase27 $
      ...
      KNormal.Let ("y.8", Type.Int) (KNormal.Var "Ti4.5") $
      KNormal.Let ("b.7", Type.Bool) (KNormal.Var "Ti3.4") $
      KNormal.Let ("x.6", Type.Int) (KNormal.Var "Ti2.1") $
    ...
    specHelper 2 validCase27 $
      ...
      KNormal.Let ("Ti2.1", Type.Int) (KNormal.Int 3) $
      KNormal.Let ("Ti3.4", Type.Int) (KNormal.Int 1) $
      KNormal.Let ("Ti4.5", Type.Int) (KNormal.Int 3) $ KNormal.Let ("Ti5.9", Type.Int) (KNormal.Int 0) $ KNormal.Int 6
